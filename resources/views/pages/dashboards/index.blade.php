...
@section('content')
    <div class="row row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1 g-3 mb-3">
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <div class="text-muted text-uppercase">Requests</div>
                    <div class="mt-1">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-1">
                        ...
                        <span class="text-success ms-1">18 <i class="fa fa-caret-up"></i></span>
                    </div>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <div class="text-muted text-uppercase">Essential Drugs</div>
                    <div class="mt-1">
        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <div class="text-muted text-uppercase">Comsumable Drugs</div>
                    <div class="mt-1">
