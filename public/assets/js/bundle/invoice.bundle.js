...
$(document).ready(function () {
    ...
    $("#addrow").on('click', function () {
        $(".item-row:last").after('<tr class="item-row"><td class="item-name"><div class="delete-wpr"><textarea>Drug Code</textarea><a class="delete" href="javascript:;" title="Remove row" onClick="removeInvoiceRow(this)">X</a></div></td><td class="description"><textarea>Description</textarea></td><td><textarea class="cost">0</textarea></td><td><textarea class="qty">0</textarea></td></tr>');
